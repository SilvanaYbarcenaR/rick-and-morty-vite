...
const Card = ({id, name, species, gender, image, onClose, addFav, removeFav, myFavorites}) => {
   ...
   return (
      <div className={cardStyles.card}>
         {
            isFav ? (
               <button className={cardStyles.favorite} onClick={handleFavorite}><BsFillSuitHeartFill className={cardStyles.fill}/></button>
            ) : (
               <button className={cardStyles.favorite} onClick={handleFavorite}><BsSuitHeart className={cardStyles.nofill}/></button>
            )
         }
